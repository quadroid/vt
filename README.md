...
*Впечатляющую широту возможностей и гибкость компонента наглядно демострирует [DRKB Explorer](https://github.com/quadroid/drkb). Все деревья и списки в приложении реализованы с помощью __Virtual TreeView__.*
